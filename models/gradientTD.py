    ...
    def learn(self, env, n_episodes=10, verbose_freq=None):
        for i in range(n_episodes):
            if verbose_freq and not i % verbose_freq:
                # print(self.theta)
                print("weight:", self.model.linear.weight.item(), "bias:", self.model.linear.bias.item())
...
if __name__ == "__main__":
    data = preprocess_data("../data/data1.xlsx")
    data[["AGG_Returns", "MSCI_Returns"]] = data[["AGG_Returns", "MSCI_Returns"]] / 100 # rescale for pytoch linear
